          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-white/80 dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="/contact"
                    className="rounded-md bg-primary px-8 py-4 text-base font-semibold text-white/80 duration-300 ease-in-out hover:bg-primary/80"
                  >
                    🔥 Talk To Sales
                  </Link>
                  <Link
