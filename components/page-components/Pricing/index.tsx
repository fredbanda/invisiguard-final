    ...
    <section id="pricing" className="relative z-10 py-16 md:py-20 lg:py-28 ">
      <div className="container">
        <SectionTitle
          ...
          paragraph="There are many variations of passages to suit the size of your business. Money is what you are in business for so don&apos;t let anyone steal it from you."
          center
          width="665px"
        />
