const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="relative z-10 rounded-sm bg-blue-300 px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark">
