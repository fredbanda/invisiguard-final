...
const NavbarMain = () => {
  ...
  if (status === "loading") {
    // Render nothing or a loading spinner while the session is being determined
    return null;
  }
          ...
          {session ? (
            ...
            <div className="flex space-x-3">
              <Link href="/auth/login">
                <Button variant="custom"  className="w-full border border-gray-300">Login</Button>
              </Link>
              <Link href="/auth/register">
                <Button variant="custom"  className="w-full border border-gray-300">
                  Register
                </Button>
              </Link>
            </div>
